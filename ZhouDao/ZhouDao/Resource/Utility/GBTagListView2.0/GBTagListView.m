...
-(void)setTagWithTagArray:(NSArray*)arr{
    ...
    [arr enumerateObjectsUsingBlock:^(NSString*str, NSUInteger idx, BOOL *stop) {
        ...
        [tagBtn setTitleColor:NINEColor forState:UIControlStateNormal];
        [tagBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateSelected];
        tagBtn.titleLabel.font= [UIFont systemFontOfSize:10.f]; //[UIFont boldSystemFontOfSize:15];
...
//        tagBtn.layer.borderWidth=0.6;
        ...
        tagBtn.backgroundColor = [UIColor colorWithHexString:@"#F5F5F5"];
