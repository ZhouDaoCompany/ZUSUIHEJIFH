$(document).ready(function(){
    ...
    $(".sub").click(function(){
        ...
        appoint_money = num1*date3*rate_ch;

        $(".appoint_money").text(appoint_money.toFixed(2));

        $(".appoint_date , .bank_day").text(date3);
        ...
        for(var item in abc){
            ...
            if(endTime < item){
                ...
                $('.bank_money').text(breachMoney.toFixed(2));
               return false;
            }
        ...
        if(beginTime > lastTime){
            item = beginTime;
            differYear      = endTime.substring(0,4);
            differMonth     = endTime.substring(4,6);
            differDay       = endTime.substring(6,8);
            var stamp = new Date(differYear,differMonth-1,differDay,0,0,0);

            differYearOld      = item.substring(0,4);
            differMonthOld     = item.substring(4,6);
            differDayOld       = item.substring(6,8);
            var stampOld = new Date(differYearOld,differMonthOld-1,differDayOld,0,0,0);
    ...
    $(".reset").click(function(){
        $(".appoint_money").text(00);
        $(".appoint_date , .bank_day").text(0);
        $('.bank_money').text(0);
    });
});