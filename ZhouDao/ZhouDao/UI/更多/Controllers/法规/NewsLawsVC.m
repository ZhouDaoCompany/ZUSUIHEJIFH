...
- (void)dropDownBoxToChoose
{
    _effectCurrent = 0;
    _timeCurrent = -1;
    _effectArr = [NSMutableArray arrayWithObjects:@"全部法律",@"法律",@"行政法规",@"司法解释",@"部门规章",@"军事法规规章",@"行业规定",@"团体规定",@"国务院",@"地方性法规",@"地方规章",@"单行条例和自治条例",@"地方司法文件",@"地方规范性文件",@"外国语国际法律",@"立法动态", nil];
