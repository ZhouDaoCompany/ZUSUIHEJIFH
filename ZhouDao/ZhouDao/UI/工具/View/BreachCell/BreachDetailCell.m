...
- (void)settUIWithArrays:(NSArray *)arrays
{
    ...
    _label1.text = [NSString stringWithFormat:@"%@-%@",[QZManager changeTimeMethods:[startTime integerValue] withType:@"yy/MM/dd"],[QZManager changeTimeMethods:[endTime integerValue] withType:@"yy/MM/dd"]];
