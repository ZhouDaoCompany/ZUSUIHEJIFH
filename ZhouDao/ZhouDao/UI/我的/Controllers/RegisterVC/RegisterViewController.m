...
- (void)initUI
{
    ...
    _phoneText = [[UITextField alloc] initWithFrame:CGRectMake(40, 5, bottomWith -40, 30)];
    ...
    _codeText = [[UITextField alloc] initWithFrame:CGRectMake(40, 45, bottomWith -140, 30)];
    ...
    _keyText = [[UITextField alloc] initWithFrame:CGRectMake(40, 85, bottomWith -140, 30)];
    ...
    _eyeImgView = [[UIImageView alloc] initWithFrame:CGRectMake(bottomWith- 40, 93, 20, 14)];
    ...
    _placeLab = [[UILabel alloc] initWithFrame:CGRectMake(40, 125, bottomWith -40, 30)];
    _placeLab.text = @"职业";
    _placeLab.font = Font_14;
    _placeLab.textColor  = [UIColor lightGrayColor];
    [_bottomView   addSubview:_placeLab];
    
    _professionalLab = [[UILabel alloc] initWithFrame:CGRectMake(40, 125, bottomWith -40, 30)];
    ...
    [_bottomView addSubview:_professionalLab];
